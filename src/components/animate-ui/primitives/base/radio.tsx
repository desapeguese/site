...
const [RadioGroupProvider, useRadioGroup] = getStrictContext<RadioGroupContextType>("RadioGroupContext");
...
type RadioIndicatorProps = Omit<React.ComponentProps<typeof RadioPrimitive.Indicator>, "asChild" | "forceMount"> &
  HTMLMotionProps<"div">;
...
type RadioProps = Omit<React.ComponentProps<typeof RadioPrimitive.Root>, "asChild"> & HTMLMotionProps<"button">;
