    ...
    <div className="fixed w-full z-50">
      <div className="flex items-center justify-between px-5 lg:px-[6.25rem] p-2 my-0 mx-auto">
        ...
        <div className="flex items-center justify-center h-[1.925rem] px-2 gap-x-4">
          <div className="flex items-center justify-center h-[1.925rem] px-2 gap-x-4">
            <button onClick={() => openInNewTab("https://www.instagram.com/biomob/")}>
            ...
            <button onClick={() => openInNewTab("https://pt-br.facebook.com/biomob/")}>
            ...
            <button onClick={() => openInNewTab("https://www.youtube.com/@biomob")}>
