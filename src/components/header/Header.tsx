...
export const Header = ({ href = "/" }: HeaderProps) => {
  ...
  return (
    <header className="header max-w-[1220px] w-full bg-[rgb(var(--var-marca-100-08))] backdrop-blur-lg min-h-[4.5rem] flex items-center justify-center px-4 max-sm:px-2 max-2sm:flex-col-reverse max-2sm:py-1 fixed top-[45px] z-50">
