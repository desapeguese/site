...
export function SpotlightCard({
  ...
  return (
    <Card
      className={`group relative overflow-hidden border rounded-lg ${className ?? ""}`}
      style={
        {
    ...
    >
      ...
      />
      <CardContent className="flex flex-col justify-start items-start w-full h-full p-6">{children}</CardContent>
    </Card>
  );
}
